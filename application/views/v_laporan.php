              ...
              <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                  ...
                  <!-- <div class="card-tools">
                    ...
                    ?>
                      <a href="<?php //echo base_url() . 'index.php/control_sales/add_sales_more/' . $row->id 
                                ?>" class="btn btn-primary pull-right" role="button">New Booking Order</a></i>
                    <?php //endforeach; 
                    ?>
                  </div> -->
