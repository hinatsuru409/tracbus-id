          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="<?php echo base_url() . 'index.php/control_sales/add_sales' ?>" class="btn btn-primary pull-right btn-sm" role="button"><i class="fa fa-plus"></i> Tambah Data</a>
                <a href="<?php echo base_url() . 'index.php/control_admin/view_laporan' ?>" class="btn btn-success pull-right btn-sm" role="button"><i class="fa fa-download"></i>&nbsp;Export Tabel</a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped text-center">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><span id="txt-formdisk"></span></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
...
<script>
  ...
  $(document).ready(function() {
    var dataTable = $('#table1').DataTable({
      ...
      "order": [],
      "ajax": {
        url: "<?php echo base_url() . 'index.php/control_sales/jsonSales'; ?>",
        type: "POST"
      },
      "columnDefs": [{
          "targets": 0,
