          ...
          <section class="content">
            <div class="container-fluid">
              <?php foreach ($sales as $row) : ?>
                <form role="form" action="<?php echo base_url() . 'index.php/control_sales/updateSales'; ?>" method="POST">
                  <div class="card card-default">
                    ...
                    <div class="card-body">
                      <div class="row">
                      <input type="hidden" name="id-sales" value="<?= $row->id ?>">
                        <!-- /.col -->
                        <div class="col-md-12">
                          <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control  <?= form_error('bko') ? 'is-invalid' : '' ?>" name="bko" placeholder="Masukkan kode Booking Order" value="<?= $row->booking_order ?>">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control <?= form_error('profit') ? 'is-invalid' : '' ?>" name="profit">
                                  ...
                                  <?php switch ($row->profit_center) {
                                    case 'UB01': ?>
                                      <option value="UB01" selected>UB01</option>
                                      <option value="UB02">UB02</option>
                                    <?php break;
                                    case 'UB02': ?>
                                      <option value="UB01">UB01</option>
                                      <option value="UB02" selected>UB02</option>
                                  <?php break;
                                    default:
                                  } ?>
                                </select>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('pic') ? 'is-invalid' : '' ?>" name="pic" placeholder="Masukkan PIC Sales" value="<?= $row->pic_sales ?>">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('nama_cmd') ? 'is-invalid' : '' ?>" name="nama_cmd" placeholder="Masukkan nama Customer Master Data" value="<?= $row->nama_cmd ?>">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('ins') ? 'is-invalid' : '' ?>" name="ins" placeholder="Masukkan nama Instansi Perusahaan, Sekolah, Tour & Travel, dll" value="<?= $row->nama_instansi ?>">
                                  ...
                                  <select class="form-control <?= form_error('jpm') ? 'is-invalid' : '' ?>" name="jpm">
                                    ...
                                    <?php switch ($row->jenis_bayar) {
                                      ...
                                      case 'IN Advanced': ?>
                                        ...
                                        <option value="IN Advanced" selected>IN Advanced</option>
                                    <?php break;
                                      default:
                                    } ?>
                                  </select>
                              ...
                              <div class="form-group">
                                ...
                                <select class="spek-select form-control <?= form_error('sp') ? 'is-invalid' : '' ?>" name="sp">
                                  ...
                                  <?php foreach ($spesifikasi as $sp) : ?>
                                    <option <?php if ($row->spesifikasi == $sp->jenis_spek) echo "selected" ?> value="<?= $sp->jenis_spek; ?>"><?= $sp->jenis_spek; ?></option>
                                  <?php endforeach; ?>
                                </select>
                              ...
                              <div class="form-group">
                                ...
                                <select class="source-select form-control <?= form_error('sd') ? 'is-invalid' : '' ?>" name="sd">
                                  ...
                                  <?php foreach ($source_data as $sd) : ?>
                                    <option <?php if ($row->source_data == $sd->jenis_source) echo "selected" ?> value="<?php echo $sd->jenis_source; ?>"><?php echo $sd->jenis_source; ?></option>
                                  <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <select class="form-control <?= form_error('grp') ? 'is-invalid' : '' ?>" name="grp">
                                  ...
                                  <?php switch ($row->group) {
                                    case 'NON-AFFCO': ?>
                                      <option value="NON-AFFCO" selected>NON-AFFCO</option>
                                      <option value="AFFCO">AFFCO</option>
                                    <?php break;
                                    case 'AFFCO': ?>
                                      <option value="NON-AFFCO">NON-AFFCO</option>
                                      <option value="AFFCO" selected>AFFCO</option>
                                  <?php break;
                                    default:
                                  } ?>
                                </select>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('cmd') ? 'is-invalid' : '' ?>" name="cmd" placeholder="Masukkan tipe CMD" value="<?= $row->cmd ?>">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('pcus') ? 'is-invalid' : '' ?>" name="pcus" placeholder="Masukkan nama customer" value="<?= $row->pic_customer ?>">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('picc') ? 'is-invalid' : '' ?>" name="picc" placeholder="Masukkan kontak Person In Charge" value="<?= $row->pic_contact ?>">
                          ...
                          <div class="row">
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('npl') ? 'is-invalid' : '' ?>" name="npl" id="drop-npl" value="<?= $row->nopol ?>">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('tyunit') ? 'is-invalid' : '' ?>" name="tyunit" value="<?= $row->type_unit ?>">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('kg') ? 'is-invalid' : '' ?>" name="kg" value="<?= $row->kategori ?>">
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('seat') ? 'is-invalid' : '' ?>" name="seat" value="<?= $row->seat ?>">
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                <label>Driver</label>
                                <input type="text" class="form-control <?= form_error('drv') ? 'is-invalid' : '' ?>" name="drv" placeholder="Masukkan nama Driver" value="<?= $row->driver ?>">
                              ...
                              <div class="form-group">
                                ...
                                <select class="sewa-select <?= form_error('sw') ? 'is-invalid' : '' ?>" style="width: 100%;" name="sw">
                                  ...
                                  <?php foreach ($maksud_sewa as $sw) : ?>
                                    <option <?php if ($row->maksud_sewa == $sw->jenis_sewa) echo "selected" ?> value="<?php echo $sw->jenis_sewa; ?>"><?php echo $sw->jenis_sewa; ?></option>
                                  <?php endforeach; ?>
                                </select>
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= form_error('rt') ? 'is-invalid' : '' ?>" name="rt" placeholder="Masukkan tempat tujuan yang dipilih" value="<?= $row->rute ?>">
                                <div class="invalid-feedback"><?= form_error('rt')  ?></div>
                              </div>
                              <div class="form-group">
                                <label>Provinsi</label>
                                <input type="text" class="form-control <?= form_error('pr') ? 'is-invalid' : '' ?>" name="pr" placeholder="Masukkan nama Daerah/Provinsi" value="<?= $row->provinsi ?>">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <textarea class="form-control <?= form_error('address') ? 'is-invalid' : '' ?>" name="address" rows="4" placeholder="Enter ..."><?= $row->alamat ?></textarea>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group date">
                                  <input type="text" class="form-control <?= form_error('tgl_mulai_p') ? 'is-invalid' : '' ?>" id="reservationdate" autocomplete="off" name="tgl_mulai_p" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->order_start ?>" />
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group date">
                                  <input type="text" class="form-control <?= form_error('tgl_akhir_p') ? 'is-invalid' : '' ?>" id="reservationdate2" autocomplete="off" name="tgl_akhir_p" placeholder="Masukkan Tanggal akhir pemesanan" value="<?= $row->order_end ?>" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control <?= form_error('wkts') ? 'is-invalid' : '' ?>" autocomplete="off" id="countFromDate" min="0" name="wkts" placeholder="Masukkan durasi waktu sewa" value="<?= $row->order_day ?>">
                                  <span>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="rvnu" id="revenueunit" onkeyup="updateSummary()" value="<?= $row->revenue_unit ?>">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="addc" id="addcharge" onkeyup="updateSummary()" value="<?= $row->addcharge ?>">
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="ket_addc" rows="2" placeholder="Enter ..."><?= $row->addcharge_ket ?></textarea>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control" name="total_rvnu" id="totalrevenue" value="<?= $row->revenue_total ?>">
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-8">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="prcl" id="pricelist" value="<?= $row->price_list ?>">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" class="form-control" name="dsk" placeholder="Masukkan besaran diskon" id="diskon" value="<?= $row->diskon ?>">
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <!-- Payment Form -->
                          <!-- Payment 1-->
                          <input type="hidden" name="id-payment" value="<?= $row->id_payment ?>">
                          <div class="row">
                            <div class="col">
                              <div class="form-group">
                                <label>Pembayaran 1</label>
                                <input type="text" class="form-control" name="py1" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_1 ?>">
                              </div>
                            </div>
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control payment-date" id="paymentdate" autocomplete="off" name="tgl_py1" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_1 ?>" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py1" value="<?= $row->pay_nom_1 ?>">
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="py2" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_2 ?>">
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control payment-date" id="paymentdate2" autocomplete="off" name="tgl_py2" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_2 ?>" />
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                  </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py2" value="<?= $row->pay_nom_2 ?>">
                                </div>
                              </div>
                              <div class="col-sm-2 align-self-end">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="py3" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_3 ?>">
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control payment-date" id="paymentdate3" autocomplete="off" name="tgl_py3" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_3 ?>" />
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                  </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py3" value="<?= $row->pay_nom_3 ?>">
                                </div>
                              </div>
                              <div class="col-sm-2 align-self-end">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="py4" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_4 ?>">
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control payment-date" id="paymentdate4" autocomplete="off" name="tgl_py4" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_4 ?>" />
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                  </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py4" value="<?= $row->pay_nom_4 ?>">
                                </div>
                              </div>
                              <div class="col-sm-2 align-self-end">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="py5" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_5 ?>">
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control payment-date" id="paymentdate5" autocomplete="off" name="tgl_py5" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_5 ?>" />
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                  </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py5" value="<?= $row->pay_nom_5 ?>">
                                </div>
                              </div>
                              <div class="col-sm-2 align-self-end">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="py6" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_6 ?>">
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control payment-date" id="paymentdate6" autocomplete="off" name="tgl_py6" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_6 ?>" />
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                  </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py6" value="<?= $row->pay_nom_6 ?>">
                                </div>
                              </div>
                              <div class="col-sm-2 align-self-end">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="py7" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_7 ?>">
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control payment-date" id="paymentdate7" autocomplete="off" name="tgl_py7" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_7 ?>" />
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                  </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py7" value="<?= $row->pay_nom_7 ?>">
                                </div>
                              </div>
                              <div class="col-sm-2 align-self-end">
                                <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="py8" placeholder="Masukkan jenis akun bank" value="<?= $row->pay_8 ?>">
                                </div>
                              </div>
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <input type="text" class="form-control payment-date" id="paymentdate8" autocomplete="off" name="tgl_py8" placeholder="Masukkan Tanggal mulai pemesanan" value="<?= $row->pay_tgl_8 ?>" />
                                    <div class="input-group-append">
                                      <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                  </div>
                              ...
                              <div class="col">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" placeholder="Masukkan nominal uang" name="nom_py8" value="<?= $row->pay_nom_8 ?>">
                                </div>
                              </div>
                              <div class="col-sm-2 align-self-end">
                                <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-md-8">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="number" class="form-control" name="total_py" id="totalpayment" placeholder="Masukkan jumlah total pembayaran" onkeyup="subtracPayment()" value="<?= $row->total_payment ?>">
                                </div>
                              </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md">
                              <div class="form-group">
                                <label>PPh 23</label>
                                <input type="number" min="0" class="form-control" name="pph" id="pph23" placeholder="Masukkan hasil PPH" value="<?= $row->pph_23 ?>">
                              </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-8">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="slpy" id="selisih-py" placeholder="Masukkan selisih pembayaran (Payment - Revenue)" value="<?= $row->sel_payment ?>">
                              </div>
                              <div class="form-group">
                                <label>Catatan Lainnya</label>
                                <textarea class="form-control" name="note" rows="2" placeholder="Enter ..."><?= $row->ket_payment ?></textarea>
                              </div>
                            </div>
                          ...
                          <div class="col border-bottom mb-4 mt-3"></div>
                          <input type="hidden" name="id-upload" value="<?= $row->id_upload ?>">
                          <!-- Upload Form -->
                          <div class="form-group">
                            <label>Upload Tahap 1</label>
                            <div class="input-group">
                              <input type="text" name="upl-1" class="form-control upload-date" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_1 ?>">
                          ...
                          <div class="form-group upload-form-block-1" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-2" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_2 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-2" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-3" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_3 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-3" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-4" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_4 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-4" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-5" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_5 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-5" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-6" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_6 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-6" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-7" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_7 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-7" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-8" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_8 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-8" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-9" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_9 ?>">
                              <div class="col-sm-2 col-form-group">
                          ...
                          <div class="form-group upload-form-block-9" style="display:none !important;">
                            ...
                            <div class="input-group">
                              <input type="text" class="form-control upload-date" name="upl-10" placeholder="Masukkan kode upload" width="100%" value="<?= $row->upload_10 ?>">
                              <div class="col-sm-2 col-form-group">
