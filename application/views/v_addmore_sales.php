                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control" id="paymentdate3" autocomplete="off" name="tgl_py2" placeholder="Masukkan Tanggal mulai pemesanan" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control" id="paymentdate4" autocomplete="off" name="tgl_py2" placeholder="Masukkan Tanggal mulai pemesanan" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control" id="paymentdate5" autocomplete="off" name="tgl_py2" placeholder="Masukkan Tanggal mulai pemesanan" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control" id="paymentdate6" autocomplete="off" name="tgl_py2" placeholder="Masukkan Tanggal mulai pemesanan" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control" id="paymentdate7" autocomplete="off" name="tgl_py2" placeholder="Masukkan Tanggal mulai pemesanan" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  <input type="text" class="form-control" id="paymentdate8" autocomplete="off" name="tgl_py2" placeholder="Masukkan Tanggal mulai pemesanan" />
                                  <div class="input-group-append">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                  </div>
                                </div>
