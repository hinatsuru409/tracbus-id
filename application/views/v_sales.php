            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="<?php echo base_url() . 'index.php/control_admin/add_sales' ?>" class="btn btn-primary btn-sm" role="button">+ Tambah Data</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-footer justify-content-between">
                    ...
                    <div class="card-tools">
                      <a href="<?php echo base_url() . 'index.php/control_admin/add_bookingnew' ?>" class="btn btn-primary pull-right" role="button">New Booking Order</a></i>
                    </div>
                  </div>
                  <!-- /.modal-content -->
                </div>
