	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				...
				<p>Don't have an Account? <a href="<?php echo base_url(). 'index.php/control_admin/view_login' ?>" > Login Now!</a></p>
			</div>
		</div>
		<!-- copyright -->
		<div class="colorlibcopy-agile">
			<p>© 2022 Signup Form. All rights reserved | Design by <a href="https://colorlib.com/" target="_blank"></a></p>
		</div>
		<!-- //copyright -->
